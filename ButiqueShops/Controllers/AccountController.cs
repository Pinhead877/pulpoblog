...
namespace ButiqueShops.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        /// <summary>
        /// Account Controlelr with the usermanger and signin manger
        /// </summary>
        ...
        /// </summary>
        /// <param name="returnUrl">the page that redirected you to login</param>
        /// <returns></returns>
        [AllowAnonymous]
        ...
        /// <summary>
        /// Post the login details the user writes
        /// </summary>
        /// <param name="model"></param>
        /// <param name="returnUrl">to the last page the user visited</param>
        /// <returns></returns>
        [HttpPost]
        [AllowAnonymous]
        ...
        /// <summary>
        /// registers a new user in the system a simple user
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        [HttpPost]
        ...
        /// <summary>
        /// login the user off from the system
        /// </summary>
        /// <returns></returns>
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        /// <summary>
        /// opens the uper profile
        /// there is a different profile to each user
        /// </summary>
        /// <returns></returns>
        [Authorize]
